    ...
    <section id="about" class="home-section text-center">
        ...
        <div class="row">
			...
			<div class="col-sm-4">
				...
				<div class="container fluid"> <!--carruse-->
				<h4>EQUIPO DE TRABAJO CEUPROPSF:</h4>
<div class="container">
  <br>
  <div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
      <div class="item active">
        <img src="<?=base_url()?>static/img/team/ceu1.jpg" alt="Chania" width="300" height="300">

      </div>

      <div class="item">
        <img src="<?=base_url()?>static/img/team/ceu2.jpg" alt="Chania" width="300" height="300">
      </div>
    
      <div class="item">
        <img src="<?=base_url()?>static/img/team/ceu3.jpg" alt="Flower" width="300" height="300">
      </div>

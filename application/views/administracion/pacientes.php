...
<script type="text/javascript" src="<?=base_url()?>static/js/pacientes/pacientes.js"></script>
                  ...
                  <div class="panel panel-primary">
                    <div class="panel-heading panel-heading-custom">
                      <h4 class="panel-title">
                        <a data-toggle="collapse" data-parent="#accordion" href="#collapse1" id="ltPaciente">
                        LISTAR PACIENTE</a>
                      </h4>
                    </div>
                      ...
                      <div class="panel-body">                        
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <table class="table table-striped table-bordered " cellspacing="0" width="100%" id="tbPaciente">
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody>
                                        ...
                                        if (isset($pacientes)) {
                                            foreach ($pacientes as $paciente) {
                                                echo "<tr>";
                                                echo "<td>";
                                                echo ($paciente['pac_id']);
                                                echo "</td>";
                                                echo "<td>";
                                                echo ($paciente['pac_ced']);
                                                echo "</td>";
                                                echo "<td>";
                                                echo ($paciente['pac_nom']);
                                                echo "</td>";
                                                echo "<td>";
                                                echo ($paciente['pac_ape']);
                                                echo "</td>";
                                                echo "<td>";
                                                echo ($paciente['pac_dir']);
                                                echo "</td>";
                                                echo "<td>";
                                                echo ($paciente['pac_cor']);
                                                echo "</td>";
